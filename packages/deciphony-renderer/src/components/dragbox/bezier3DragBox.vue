...
let currentKey: 'startPoint' | 'endPoint' | 'leftSlope' | 'rightSlope' | '' = ''
...
// pointerdown
function onPointerDown(e: PointerEvent, key: "startPoint" | "endPoint" | "leftSlope" | "rightSlope") {
    isDragging = true
    currentKey = key
...
<template>
    <!-- 虚线框 -->
    <path :d="rectPath" fill="transparent" stroke="black" stroke-dasharray="4" stroke-width="1"/>
    <slot></slot>
    <!-- 拖拽点 -->
    <circle
