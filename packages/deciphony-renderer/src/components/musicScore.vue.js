...
function resolveTopVDom(event) {
    return resolveVDomFromEvent(event, vDom.value);
}
function syncTopHover(event) {
...
function onTopMove(event) {
    syncTopHover(event);
    emit('top-move', event, resolveTopVDom(event));
}
function onTopSvgEnter(event) {
    syncTopHover(event);
}
function onTopSvgLeave(event) {
    const prev = topHoverVDom.value;
    if (prev)
        emit('top-leave', event, prev);
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.svg, __VLS_intrinsicElements.svg)({
    ...{ onClick: (__VLS_ctx.onTopClick) },
    ...{ onPointerdown: (__VLS_ctx.onTopDown) },
    ...{ onPointerenter: (__VLS_ctx.onTopSvgEnter) },
    ...{ onPointerleave: (__VLS_ctx.onTopSvgLeave) },
    ...{ onPointermove: (__VLS_ctx.onTopMove) },
    ...{ onPointerup: (__VLS_ctx.onTopUp) },
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            onTopUp: onTopUp,
            onTopMove: onTopMove,
            onTopSvgEnter: onTopSvgEnter,
            onTopSvgLeave: onTopSvgLeave,
        };
    },
    __typeEmits: {},
    __typeProps: {},
