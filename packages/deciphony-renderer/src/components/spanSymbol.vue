...
<template>
    ...
    <voltaVue v-if="spanSymbol && spanSymbol.type === SpanSymbolTypeEnum.volta" ..mousedown.self="handleMouseDown"
              ..mouseup.self="handleMouseUp" :volta="spanSymbol"
    ></voltaVue>

    <slurVue v-if="spanSymbol && spanSymbol.type === SpanSymbolTypeEnum.slur" ..mousedown.self="handleMouseDown"
