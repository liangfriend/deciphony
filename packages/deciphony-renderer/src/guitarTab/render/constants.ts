...
export const GUITAR_TAB_BEND_PERIOD_ONE_HEIGHT_RATIO = 1;
/** 推弦阶段2 默认高度（× measureHeight） */
export const GUITAR_TAB_BEND_PERIOD_TWO_HEIGHT_RATIO = 0.25;
/** 推弦标注与箭头端点的垂直间距（× measureHeight，向上为负 y） */
export const GUITAR_TAB_BEND_TEXT_OFFSET_RATIO = 0.12;
/** 推弦线宽（× measureHeight，最小 1px） */
export const GUITAR_TAB_BEND_THICKNESS_RATIO = 1 / 32;
