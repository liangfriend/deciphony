...
function repeatTextSkin(label, w, h, centered) {
...
function makeKeySignature(key) {
    ...
    if (sharpCount > 0) {
        ...
        const content = items.map(({ x, y }) => `<g transform="translate(${x.toFixed(2)},${y.toFixed(2)})">${SHARP_INNER}</g>`).join('');
    ...
    if (flatCount > 0) {
        ...
        const content = items.map(({ x, y }) => `<g transform="translate(${x.toFixed(2)},${y.toFixed(2)})">${FLAT_INNER}</g>`).join('');
...
// 拍号
function makeTimeSignature(content, key) {
...
// 符尾
function makeNoteTail(multiplier, key) {
...
function makeNoteTailReversed(key) {
...
`,
    ...
    [StandardStaffSkinKeyEnum.Accent_above]: {
        ...
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Accent_above,
    },
    [StandardStaffSkinKeyEnum.Staccato_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Staccato_above,
    },
    [StandardStaffSkinKeyEnum.Tenuto_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Tenuto_above,
    },
    [StandardStaffSkinKeyEnum.Loure_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Loure_above,
    },
    [StandardStaffSkinKeyEnum.Marcato_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Marcato_above,
    },
    [StandardStaffSkinKeyEnum.Accent_staccato_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Accent_staccato_above,
    },
    [StandardStaffSkinKeyEnum.Marcato_staccato_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Marcato_staccato_above,
    },
    [StandardStaffSkinKeyEnum.Marcato_tenuto_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Marcato_tenuto_above,
    },
    [StandardStaffSkinKeyEnum.Staccatissimo_stroke_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Staccatissimo_stroke_above,
    },
    [StandardStaffSkinKeyEnum.Staccatissimo_wedge_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Staccatissimo_wedge_above,
    },
    [StandardStaffSkinKeyEnum.Stress_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Stress_above,
    },
    [StandardStaffSkinKeyEnum.Tenuto_accent_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Tenuto_accent_above,
    },
    [StandardStaffSkinKeyEnum.Unstress_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Unstress_above,
    },
    [StandardStaffSkinKeyEnum.Open]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Open,
    },
    [StandardStaffSkinKeyEnum.Muted]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Muted,
    },
    [StandardStaffSkinKeyEnum.Harmonic]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Harmonic,
    },
    [StandardStaffSkinKeyEnum.Up_bow]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Up_bow,
    },
    [StandardStaffSkinKeyEnum.Down_bow]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Down_bow,
    },
    [StandardStaffSkinKeyEnum.Turn]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Turn,
    },
    [StandardStaffSkinKeyEnum.InvertedTurn]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.InvertedTurn,
    },
    [StandardStaffSkinKeyEnum.Trill]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Trill,
    },
    [StandardStaffSkinKeyEnum.ShortTrill]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.ShortTrill,
    },
    [StandardStaffSkinKeyEnum.Mordent]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Mordent,
    },
    [StandardStaffSkinKeyEnum.Arpeggio]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Arpeggio,
    },
    [StandardStaffSkinKeyEnum.Up_arpeggio]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Up_arpeggio,
    },
    [StandardStaffSkinKeyEnum.Down_arpeggio]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Down_arpeggio,
    },
    [StandardStaffSkinKeyEnum.Bracket_arpeggio]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Bracket_arpeggio,
    },
    [StandardStaffSkinKeyEnum.Up_arpeggio_straight]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Up_arpeggio_straight,
    },
    [StandardStaffSkinKeyEnum.Down_arpeggio_straight]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Down_arpeggio_straight,
    },
    [StandardStaffSkinKeyEnum.Dyn_PPP]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_PPP,
    },
    [StandardStaffSkinKeyEnum.Dyn_PP]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_PP,
    },
    [StandardStaffSkinKeyEnum.Dyn_P]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_P,
    },
    [StandardStaffSkinKeyEnum.Dyn_MP]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_MP,
    },
    [StandardStaffSkinKeyEnum.Dyn_MF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_MF,
    },
    [StandardStaffSkinKeyEnum.Dyn_F]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_F,
    },
    [StandardStaffSkinKeyEnum.Dyn_FF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_FF,
    },
    [StandardStaffSkinKeyEnum.Dyn_FFF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_FFF,
    },
    [StandardStaffSkinKeyEnum.Dyn_FP]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_FP,
    },
    [StandardStaffSkinKeyEnum.Dyn_PF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_PF,
    },
    [StandardStaffSkinKeyEnum.Dyn_SF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_SF,
    },
    [StandardStaffSkinKeyEnum.Dyn_SFZ]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_SFZ,
    },
    [StandardStaffSkinKeyEnum.Dyn_SFF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_SFF,
    },
    [StandardStaffSkinKeyEnum.Dyn_SFFZ]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_SFFZ,
    },
    [StandardStaffSkinKeyEnum.Dyn_SFP]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_SFP,
    },
    [StandardStaffSkinKeyEnum.Dyn_RFZ]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_RFZ,
    },
    [StandardStaffSkinKeyEnum.Dyn_RF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_RF,
    },
    [StandardStaffSkinKeyEnum.Dyn_FZ]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: StandardStaffSkinKeyEnum.Dyn_FZ,
    },
};
// 简谱拍号：复用五线谱的上下数字样式
function makeNumberNotationTimeSignature(top, bottom, key) {
    return {
...
`,
    ...
    [NumberNotationSkinKeyEnum.Accent_above]: {
        ...
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Accent_above,
    },
    [NumberNotationSkinKeyEnum.Staccato_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Staccato_above,
    },
    [NumberNotationSkinKeyEnum.Tenuto_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Tenuto_above,
    },
    [NumberNotationSkinKeyEnum.Loure_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Loure_above,
    },
    [NumberNotationSkinKeyEnum.Marcato_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Marcato_above,
    },
    [NumberNotationSkinKeyEnum.Accent_staccato_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Accent_staccato_above,
    },
    [NumberNotationSkinKeyEnum.Marcato_staccato_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Marcato_staccato_above,
    },
    [NumberNotationSkinKeyEnum.Marcato_tenuto_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Marcato_tenuto_above,
    },
    [NumberNotationSkinKeyEnum.Staccatissimo_stroke_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Staccatissimo_stroke_above,
    },
    [NumberNotationSkinKeyEnum.Staccatissimo_wedge_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Staccatissimo_wedge_above,
    },
    [NumberNotationSkinKeyEnum.Stress_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Stress_above,
    },
    [NumberNotationSkinKeyEnum.Tenuto_accent_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Tenuto_accent_above,
    },
    [NumberNotationSkinKeyEnum.Unstress_above]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Unstress_above,
    },
    [NumberNotationSkinKeyEnum.Open]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Open,
    },
    [NumberNotationSkinKeyEnum.Muted]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Muted,
    },
    [NumberNotationSkinKeyEnum.Harmonic]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Harmonic,
    },
    [NumberNotationSkinKeyEnum.Up_bow]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Up_bow,
    },
    [NumberNotationSkinKeyEnum.Down_bow]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Down_bow,
    },
    [NumberNotationSkinKeyEnum.Turn]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Turn,
    },
    [NumberNotationSkinKeyEnum.InvertedTurn]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.InvertedTurn,
    },
    [NumberNotationSkinKeyEnum.Trill]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Trill,
    },
    [NumberNotationSkinKeyEnum.ShortTrill]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.ShortTrill,
    },
    [NumberNotationSkinKeyEnum.Mordent]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Mordent,
    },
    [NumberNotationSkinKeyEnum.Arpeggio]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Arpeggio,
    },
    [NumberNotationSkinKeyEnum.Up_arpeggio]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Up_arpeggio,
    },
    [NumberNotationSkinKeyEnum.Down_arpeggio]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Down_arpeggio,
    },
    [NumberNotationSkinKeyEnum.Bracket_arpeggio]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Bracket_arpeggio,
    },
    [NumberNotationSkinKeyEnum.Up_arpeggio_straight]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Up_arpeggio_straight,
    },
    [NumberNotationSkinKeyEnum.Down_arpeggio_straight]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Down_arpeggio_straight,
    },
    [NumberNotationSkinKeyEnum.Dyn_PPP]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_PPP,
    },
    [NumberNotationSkinKeyEnum.Dyn_PP]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_PP,
    },
    [NumberNotationSkinKeyEnum.Dyn_P]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_P,
    },
    [NumberNotationSkinKeyEnum.Dyn_MP]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_MP,
    },
    [NumberNotationSkinKeyEnum.Dyn_MF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_MF,
    },
    [NumberNotationSkinKeyEnum.Dyn_F]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_F,
    },
    [NumberNotationSkinKeyEnum.Dyn_FF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_FF,
    },
    [NumberNotationSkinKeyEnum.Dyn_FFF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_FFF,
    },
    [NumberNotationSkinKeyEnum.Dyn_FP]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_FP,
    },
    [NumberNotationSkinKeyEnum.Dyn_PF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_PF,
    },
    [NumberNotationSkinKeyEnum.Dyn_SF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_SF,
    },
    [NumberNotationSkinKeyEnum.Dyn_SFZ]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_SFZ,
    },
    [NumberNotationSkinKeyEnum.Dyn_SFF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_SFF,
    },
    [NumberNotationSkinKeyEnum.Dyn_SFFZ]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_SFFZ,
    },
    [NumberNotationSkinKeyEnum.Dyn_SFP]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_SFP,
    },
    [NumberNotationSkinKeyEnum.Dyn_RFZ]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_RFZ,
    },
    [NumberNotationSkinKeyEnum.Dyn_RF]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_RF,
    },
    [NumberNotationSkinKeyEnum.Dyn_FZ]: {
        content: REPEAT_PLACEHOLDER_RECT,
        w: 30,
        h: 30,
        skinKey: NumberNotationSkinKeyEnum.Dyn_FZ,
    },
};
...
function applySkinColor(color) {
    ...
    const mapPack = (pack, type) => {
        const out = {};
        for (const k of Object.keys(pack)) {
            const item = pack[k];
            out[k] = { ...item, content: replaceColor(item.content) };
        }
...
export const defaultSkinRed = applySkinColor('#c00');
export const defaultSkinBlue = applySkinColor('#06c');
