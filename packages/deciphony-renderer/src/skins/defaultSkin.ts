...
`, w: 95 * 0.32, h: 248 * 0.32, skinKey: SkinKeyEnum.Treble_f
};
const bassF = {
  content: `
    <g transform="
...
`, w: 104.88 * 0.42,
  h: 106.78 * 0.42, skinKey: SkinKeyEnum.Bass_f
};
...
`;
  if (key === SkinKeyEnum.NoteHead_2) {
    return {content: tiltedEllipse, w: 14.59, h: 10.49, skinKey: key};
  }
  if (key === SkinKeyEnum.NoteHead_3) {
...
const noteStem = {
  content: `<g >
  <line x1="1" y1="0" x2="1" y2="node.h" stroke="black" stroke-width="2" />
</g>`,
  w: 2,
...
function makeNoteTail(multiplier: number, key: SkinKeyEnum) {
  if (key === SkinKeyEnum.NoteTail_1) {
    return {
      content: `<g transform="translate(0.7000, 0.0000) scale(1.5)">
  ...
  } else if (key === SkinKeyEnum.NoteTail_2) {
    return {
      content: `<g transform="translate(0.7000, 0.0000) scale(1.5)">
  ...
  } else if (key === SkinKeyEnum.NoteTail_3) {
    return {
      content: `<g transform="translate(0.7000, 4.5000) scale(1.5)">
  ...
  } else if (key === SkinKeyEnum.NoteTail_4) {
    return {
      content: `<g transform="translate(0.7000, 9.0000) scale(1.5)">
  ...
  } else if (key === SkinKeyEnum.NoteTail_5) {
    return {
      content: `<g transform="translate(0.7000, 9.8000) scale(1.5)">
  ...
  } else if (key === SkinKeyEnum.NoteTail_6) {
    return {
      content: `<g transform="translate(0.9000, 18.0000) scale(1.5)">
...
const NOTE_TAIL_R_TO_BASE: Partial<Record<SkinKeyEnum, { mult: number; key: SkinKeyEnum }>> = {
  [SkinKeyEnum.NoteTail_1_r]: {mult: 1, key: SkinKeyEnum.NoteTail_1},
  [SkinKeyEnum.NoteTail_2_r]: {mult: 1.1, key: SkinKeyEnum.NoteTail_2},
  [SkinKeyEnum.NoteTail_3_r]: {mult: 1.2, key: SkinKeyEnum.NoteTail_3},
  [SkinKeyEnum.NoteTail_4_r]: {mult: 1.3, key: SkinKeyEnum.NoteTail_4},
  [SkinKeyEnum.NoteTail_5_r]: {mult: 1.4, key: SkinKeyEnum.NoteTail_5},
  [SkinKeyEnum.NoteTail_6_r]: {mult: 1.5, key: SkinKeyEnum.NoteTail_6},
};

/** 符尾倒：复用正符尾内容，外层 scale(1,-1) translate(0,-node.h) 纵向翻转 */
function makeNoteTailReversed(key: SkinKeyEnum): { content: string; w: number; h: number; skinKey: SkinKeyEnum } {
  if (key === SkinKeyEnum.NoteTail_1_r) {
    return {
  ...
  } else if (key === SkinKeyEnum.NoteTail_2_r) {
    return {
  ...
  } else if (key === SkinKeyEnum.NoteTail_3_r) {
    return {
      content: `
...
`,
  ...
  } else if (key === SkinKeyEnum.NoteTail_4_r) {
    return {
  ...
  } else if (key === SkinKeyEnum.NoteTail_5_r) {
    return {
  ...
  } else if (key === SkinKeyEnum.NoteTail_6_r) {
    return {
...
function makeRest(key: SkinKeyEnum) {
  ...
  } else if (key === SkinKeyEnum.Rest_2) {
    return {
      content: `<rect x="0" y="0" width="10" height="6" fill="black"/>`,
      w: 10,
      h: 6,
  ...
  } else if (key === SkinKeyEnum.Rest_3) {
    return {
  ...
  } else if (key === SkinKeyEnum.Rest_4) {
    return {
  ...
  } else if (key === SkinKeyEnum.Rest_5) {
    return {
  ...
  } else if (key === SkinKeyEnum.Rest_6) {
    return {
  ...
  } else if (key === SkinKeyEnum.Rest_7) {
    return {
      content: `<g transform="translate(0.0000, 12.2260)">
  ...
  } else if (key === SkinKeyEnum.Rest_8) {
    return {
  ...
  } else if (key === SkinKeyEnum.Rest_9) {
    return {
...
export const defaultSkin: SkinPack = {
  ...
  [SkinKeyEnum.Start_end_repeat_barline]: startEndRepeatBarline,
  ...
  // 符尾倒（符干朝下时使用）
  [SkinKeyEnum.NoteTail_1_r]: makeNoteTailReversed(SkinKeyEnum.NoteTail_1_r),
  [SkinKeyEnum.NoteTail_2_r]: makeNoteTailReversed(SkinKeyEnum.NoteTail_2_r),
  [SkinKeyEnum.NoteTail_3_r]: makeNoteTailReversed(SkinKeyEnum.NoteTail_3_r),
  [SkinKeyEnum.NoteTail_4_r]: makeNoteTailReversed(SkinKeyEnum.NoteTail_4_r),
  [SkinKeyEnum.NoteTail_5_r]: makeNoteTailReversed(SkinKeyEnum.NoteTail_5_r),
  [SkinKeyEnum.NoteTail_6_r]: makeNoteTailReversed(SkinKeyEnum.NoteTail_6_r),
