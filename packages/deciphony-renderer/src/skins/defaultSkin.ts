...
const measure = {
    ...
    >
      ...
      <line x1="0" y1="11.5" x2="100" y2="11.5" stroke="black" stroke-width="1" />
      <line x1="0" y1="22.5" x2="100" y2="22.5" stroke="black" stroke-width="1" />
      <line x1="0" y1="33.5" x2="100" y2="33.5" stroke="black" stroke-width="1" />
      <line x1="0" y1="44.5" x2="100" y2="44.5" stroke="black" stroke-width="1" />
    </svg>
`,
    w: 0, // 这个对于小节本身不起作用
    h: STAFF_HEIGHT,
...
const singleBarline = {
    content: `
    <svg width="node.w" height="node.h" viewBox="0 0 10 45" preserveAspectRatio="none">
      <line x1="5" y1="0" x2="5" y2="45" stroke="black" stroke-width="1" />
    </svg>
`,
    w: 4,
    h: STAFF_HEIGHT,
...
const startRepeatBarline = {
    content: `
    <svg width="node.w" height="node.h" viewBox="0 0 18 45" preserveAspectRatio="none">
      <line x1="6" y1="0" x2="6" y2="45" stroke="black" stroke-width="1" />
...
const endRepeatBarline = {
    ...
    <svg width="node.w" height="node.h" viewBox="0 0 18 45" preserveAspectRatio="none">
      ...
      <line x1="12" y1="0" x2="12" y2="45" stroke="black" stroke-width="1" />
...
const finalBarline = {
    content: `
    <svg width="node.w" height="node.h" viewBox="0 0 12 45" preserveAspectRatio="none">
      <line x1="4" y1="0" x2="4" y2="45" stroke="black" stroke-width="1" />
...
const heavyDoubleBarline = {
    content: `
    <svg width="node.w" height="node.h" viewBox="0 0 14 45" preserveAspectRatio="none">
      <line x1="5" y1="0" x2="5" y2="45" stroke="black" stroke-width="3" />
...
function makeTimeSignature(content: string, key: SkinKeyEnum) {
  ...
  <text x="10" y="18" text-anchor="middle" font-size="14">${top}</text>
  <text x="10" y="36" text-anchor="middle" font-size="14">${bottom}</text>
</svg>`,
        w: 14,
        h: STAFF_HEIGHT,
        widthRatio: 0,
...
// 符干
const noteStem = {
    content: `<svg width="node.w" height="node.h" viewBox="0 0 4 40">
...
function makeNoteTail(multiplier: number, key: SkinKeyEnum) {
  ...
  <path d="M2 0 C8 4, 8 10, 2 14" stroke="black" stroke-width="1.2" fill="none" />
</svg>`,
        w: 6,
...
function makeRest(key: SkinKeyEnum) {
  ...
  <rect x="5" y="8" width="10" height="4" fill="black" />
</svg>`,
        w: 10,
        h: STAFF_HEIGHT * 0.6,
        widthRatio: 0,
