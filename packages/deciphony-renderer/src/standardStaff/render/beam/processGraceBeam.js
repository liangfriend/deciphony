 ...
 */
function buildBeamGroupsLeftToRight(list) {
    const groups = [];
 ...
 */
function graceStemBeamAttachX(stem, direction, indexInVisual, visualCount) {
...
function getGraceStem(nodeIdMap, vDoms, niId) {
