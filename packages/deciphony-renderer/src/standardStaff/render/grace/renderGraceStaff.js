...
import { getAccidentalSkinKey, getAugmentationDotSkinKey, getNoteHeadSkinKey, } from "../utils/skinKey";
...
export function estimateGraceNotesInfoWidth(ni, skin, measureHeight) {
...
export function graceBeforeWidth(graceNotes, skin, measureHeight) {
...
export function graceAfterWidth(graceNotesAfter, skin, measureHeight) {
    return graceBeforeWidth(graceNotesAfter, skin, measureHeight);
}
export function renderGraceNotesInfo(params) {
    const { ni, headAnchorX, noteCenterY, measureHeight, measureLineWidth, measureWidth, skin, skinName, zIndex, note, idMap, out, } = params;
...
export function renderGraceNotesBefore(graceNotes, mainHeadX, ctx) {
    if (!graceNotes?.length)
        return;
...
export function renderGraceNotesAfter(graceNotesAfter, mainHeadX, mainHeadW, ctx) {
