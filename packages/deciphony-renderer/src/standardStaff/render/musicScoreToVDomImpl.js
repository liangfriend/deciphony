...
import { slotDataForGrandStaff, slotDataForMeasure, slotDataForMusicScore, slotDataForSingleStaff, } from "@/render/slotData";
...
export function musicScoreToVDom(musicScore, slotConfig, options) {
    ...
    const skin = skinPack.standardStaff ?? defaultSkin.standardStaff;
