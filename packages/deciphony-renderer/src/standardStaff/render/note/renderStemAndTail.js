...
import { GRACE_NOTE_SCALE, graceScaleCenterOffsetX, graceScaleCenterOffsetY, graceTailCenterOffset } from "@/render/graceNote";
...
export function renderStemAndTail(params) {
    const { note, headX, headY, headW, headH, measureY, measureHeight, skin, zIndex, stemTargetId, headCenterYOther, isGrace = false, } = params;
...
export function renderGraceStemAndTail(params) {
