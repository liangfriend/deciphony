 ...
 */
function hasNonXRelativeOffset(n) {
        ...
        for (let i = 0; i < notes.length; i++) {
            ...
            * */
            ...
            if (noteAugmentationDot) {
                const augSkinKey = getAugmentationDotSkinKey(noteAugmentationDot);
             ...
             */
            const renderStemForSubgroup = (subNotes, subChronaxie, directionUp) => {
