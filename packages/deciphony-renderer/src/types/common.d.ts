...
import { MusicScore, GrandStaff, SingleStaff, Measure, NotesInfo, NotesNumberInfo, NoteSymbol, NoteNumber } from "@/types/MusicScoreType";
...
export type VDomTagType = 'title' | 'root' | 'grandStaff' | 'singleStaff' | 'measure' | 'noteHead' | 'rest' | 'clef_f' | 'clef_b' | 'keySignature_f' | 'keySignature_b' | 'timeSignature_f' | 'timeSignature_b' | 'barline_f' | 'barline_b' | 'linked_barline' | 'close_line' | 'linked_close_line' | 'bracket' | 'noteStem' | 'noteTail' | 'noteBeam' | 'accidental' | 'addLine' | 'addLine_u' | 'addLine_g' | 'repeat_f' | 'repeat_b' | 'slot' | 'space' | 'affiliation';
...
export type SlotData = {
    ...
    self: MusicScore | GrandStaff | SingleStaff | Measure | NoteSymbol | NoteNumber | NotesInfo | NotesNumberInfo;
};
