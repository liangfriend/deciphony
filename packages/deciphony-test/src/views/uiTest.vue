...
<template>
  ...
  <!--    </ds-floating-window>-->
  <!--  白板-->
  <div v-show="false" style="padding: 20px;">
  ...
  <div style="margin-top:300px">
    ...
    <ds-piano-waterfall v-show="true"></ds-piano-waterfall>
    <ds-piano v-show="true"></ds-piano>

    <!--    <ds-perform-evaluation></ds-perform-evaluation>-->
  </div>
