<template>
    <div :style="{ width, height }" class="ds-progress-bar relative flex justify-center">
        <canvas
            ref="canvas"
            :style="{ width: '100%', height: '100%' }"
            class="ds-progress-bar-canvas"
        ></canvas>
    </div>
</template>
...
<script setup>
defineOptions({
    name: 'DsProgressBar' // 给组件一个全局 name
});
