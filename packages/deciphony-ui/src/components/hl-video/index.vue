<template>
  <div class="hl-video">
    ...
    <!-- 控制条 -->
    <div v-show="operationShow" class="hl-video-controls" :class="{ disabled: !videoAvailable }">
      <div class="hl-video-controls-mask"></div>
      <div class="top">
...
.hl-video-placeholder-img {
  max-width: 100%;
  max-height: 100%;
  object-fit: contain;
}

.hl-video-placeholder-default {
  color: #888;
  font-size: 18px;
}
